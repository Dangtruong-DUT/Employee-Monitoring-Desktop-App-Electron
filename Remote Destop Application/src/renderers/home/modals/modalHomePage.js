                        ...
                        <form id='formJoinDerpart'>
                            <div class="auth-form__form">
                                <div class="form-group">
                                    ...
                                    <label class="form-label" for='maPB'>Mã phòng ban<span class="required">*</span></label>
                ...
                <div data-indexSession="${department?.id}" class="modal hidden modalexitSession">
                    ...
                    <div class="modal__body">
                        <div class="auth-form">
                            ...
                            <div class="auth-form__desc">
                                <p>Yêu cầu của bạn sẽ được xem xét và xét duyệt bởi Admin</p>
                            </div>
                            <div class="auth-form__form">
                                <div class="modal-body__title--warning">
                                    ${department?.isJoined ? `Bạn chắc chắn muốn thoát phòng ${department?.name}?` : `Bạn chắc chắn muốn hủy yêu cầu tham gia phòng ${department?.name}?`}
                                </div>
                            </div>
                            <div class="auth-form__controls">
...
export const FORMJOINDERPART = {
    ...
    onSubmit: async function (data) {
        ...
        try {
            ...
            if (responseData?.id && responseData?.name && responseData?.isJoined) {
...
async function handleEventModalDepart(state) {
    const { PersonInfor, mapb, nameFunc } = state;
    const { id: idnv, token } = PersonInfor;
