         ...
         <!--header-->
                <header class="hompage-header grid__row ">
                    ...
                    <ul class="hompage-header__listItem  header--right">
                        <li class="hompage-header__item hompage-header__item--bgCircle"><svg class="icon icon--fillNone icon--normal"
...
export const HeaderEvents = function (event) {
    ...
    if (btnReadAll) {
        ...
        Imports.showAlert("Bạn vừa đọc tất cả thông báo!","Info");
    }
    ...
    if (notiItem) {
        ...
        Imports.showAlert("Thông báo đã đọc: "+notiItem.querySelector('.title--noti').innerText,"Info");
    }
}