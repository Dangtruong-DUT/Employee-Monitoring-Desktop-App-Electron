...
function waitingConnection() {
 return html `
     <div class="waitingConnection">
            <div class="waitingConnection__img">
                <img src="../assets/imgs/waitingConnection.png" class="waitingConnection__img" alt="imgConnection">
            </div>
            ...
            <div class="waitingConnection__title">
                <p>
                    Vui lòng kết nối thiết bị của bạn với Internet để sử dụng dịch vụ!
                </p>
            </div>
        </div>
 `
